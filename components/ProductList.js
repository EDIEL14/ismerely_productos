                    ...
                    return (
                        <section id="catalogo" className="py-5 bg-light">
                            <div className="container text-center mb-4">
                                <h2 className="fw-bold text-dark">PRODUCTOS DE BATALLA</h2>
                                <p className="fs-5 text-muted">Suplementos orgánicos de alto impacto</p>
                            </div>
                            ...
                            <div className="text-center mt-5">
                                ...
                                <div className="d-flex flex-column flex-md-row justify-content-center gap-3">
                                    <a
                                        href="https://wa.me/9982140280?text=Hola vengo de la pagina web y me gustaría más información mas detalla sobre UNO de los productos de alto impacto."
                                        target="_blank"
                                        className="btn btn-success px-4 py-2 rounded shadow-sm"
                                    >
                                        Ir a Contactarla
                                    </a>
                                </div>
                    ...
                    return (
                        <div className="col-12 col-md-6 col-lg-4">
                            <div className="card border-0 shadow-sm rounded">
                                <img src={product.imageUrl} alt={product.name} className="card-img-top rounded-top img-fluid" />
